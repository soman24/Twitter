...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "dQGGH1uWpHUhbMsBsH2igVKlj", consumerSecret: "atTZbqYGEUMKOEDhRFSkBF2xCo8XSavncxdQCwQf8a6ApC8P5k")
    var loginSuccess: (() -> ())?
